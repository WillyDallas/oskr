...
3. **Quiz the developer** (one list, then iterate): granularity (too coarse / too fine?), dependency order, anything to split or merge. Do not publish until they approve.
